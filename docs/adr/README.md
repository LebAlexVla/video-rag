...
- [ADR-013 — DeepSeek используется как удалённый провайдер генерации ответа](./ADR-013-deepseek-remote-answer-provider.md)
- [ADR-014 — Google Gemini используется как облачный провайдер embeddings](./ADR-014-gemini-embedding-provider.md)
- [ADR-015 — Внешние клиенты используют основной HTTP API](./ADR-015-external-clients.md)
